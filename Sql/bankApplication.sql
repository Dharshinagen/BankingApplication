...
INSERT INTO USER_DETAILS (USER_ID,NAME,EMAIL, PASSWORD, MOBILE_NUMBER)
                   VALUES(1,'Dharshini','dharshi05@gmail.com','dharsh@13' ,9876543210);
INSERT INTO USER_DETAILS (USER_ID,NAME,EMAIL, PASSWORD, MOBILE_NUMBER)
                   VALUES(2,'Priya', 'priya24@gamail.com','priya123' ,9876543211);
INSERT INTO USER_DETAILS (USER_ID,NAME,EMAIL, PASSWORD, MOBILE_NUMBER)
                   VALUES(3,'Keerthana','keerthi05@gmail.com','keerthi123' ,9876543212);
INSERT INTO USER_DETAILS (USER_ID,NAME,EMAIL, PASSWORD, MOBILE_NUMBER)
                   VALUES(4,'Vishalini','vishali06@gmail.com','vishali123' ,9876543213);
INSERT INTO USER_DETAILS (USER_ID,NAME,EMAIL, PASSWORD, MOBILE_NUMBER)
                   VALUES(5,'Meena','meena13@gmail.com','meena123' ,9876543214);
SELECT * FROM USER_DETAILS;

 

--MODULE  ACCOUNT DETAILS
CREATE  TABLE ACCOUNT_DETAILS(ID NUMBER NOT NULL,
                       ACCOUNT_NUMBER NUMBER GENERATED ALWAYS AS IDENTITY(START WITH 112233445001 INCREMENT BY 1),
                        ...
                        CONSTRAINT FK_ID FOREIGN KEY(ID) REFERENCES USER_DETAILS(USER_ID),
...
drop table Account_details;
--MODULE  TRANSACTION
CREATE TABLE TRANSACTION(ID INT  ,ACCOUNT_NUMBER NUMBER,IFSC_CODE NUMBER NOT NULL,TRANSACTION_TYPE VARCHAR(50),AMOUNT NUMBER NOT NULL, 
                         BALANCE NUMBER NOT NULL,CONSTRAINT PK_IDTRANS,
                         CONSTRAINT FK_ACCNO FOREIGN KEY(ACCOUNT_NUMBER) REFERENCES ACCOUNT_DETAILS(ACCOUNT_NUMBER));
drop table transaction;


--MODULE  DEPOSITS(fixed deposit,recurring deposit)
CREATE TABLE DEPOSITS(ID NUMBER PRIMARY KEY, ACCOUNT_NUMBER NUMBER ,CUSTOMER_TYPE VARCHAR(20) NOT NULL,
                      DEPOSIT_TYPE VARCHAR(30)NOT NULL,AMOUNT NUMBER NOT NULL,
                      ...
                      CONSTRAINT FK_ACCNO FOREIGN KEY(ACCOUNT_NUMBER) REFERENCES ACCOUNT_DETAILS(ACCOUNT_NUMBER),
                      CONSTRAINT PK_ID_DEPOSITS PRIMARY KEY(ID));
DESC DEPOSITS;
DROP TABLE DEPOSITS;
SELECT * FROM DEPOSITS;

--MODULE  LOANS
 CREATE TABLE LOANS(ID INT,LOAN_NUMBER NUMBER ,ACCOUNT_NUMBER NUMBER,LOAN_TYPE VARCHAR(50) NOT NULL,DESCRIPTION VARCHAR(100) ,
                    ...
                    CONSTRAINT FK_ACC_NUMBER PRIMARY KEY, FOREIGN KEY(ACCOUNT_NUMBER) REFERENCES ACCOUNT_DETAILS(ACCOUNT_NUMBER));
 DESC LOANS;
 DROP TABLE LOANS;
 SELECT * FROM LOANS;
 ...
 CREATE TABLE ADMIN_USE(ID INT  ,CATEGORY VARCHAR2(50) NOT NULL,CATEGORY_TYPE VARCHAR2(50),AMOUNT_TYPE VARCHAR(50),
